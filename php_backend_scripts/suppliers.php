...
$result = mysqli_query($link, "SELECT * FROM supplier") or die(mysqli_error());
...
if (mysqli_num_rows($result) > 0) {
    ...
    echo '<table style=\'border: solid 2px black;\'>
		...
		<th style=\'width:150px;border:2px solid black;\'>Company</th>
	...
	echo '
		...
		<td style=\'width:150px;border:2px solid black;\'>'.$visitor["company"].'</td>
