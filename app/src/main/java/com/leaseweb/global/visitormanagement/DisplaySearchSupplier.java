...
public class DisplaySearchSupplier extends Activity {
    @Override
    public void onCreate(Bundle bundle) {
        super.onCreate(bundle);
        setContentView(R.layout.display_search_supplier);
        ...
        TextView tvReasonForVisit = (TextView) findViewById(R.id.companyText);
        tvReasonForVisit.setText(company);
